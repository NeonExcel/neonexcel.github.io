...
const config = {
    serverInfo: {
        ...
        serverIp: "NeonExcel", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
...
const getDiscordOnlineUsers = async () => {
    try {
        ...
        const apiWidgetUrl = `https://discord.com/api/guilds/1290701324492738654/widget.json`;
